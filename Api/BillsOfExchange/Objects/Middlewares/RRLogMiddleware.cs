...
namespace BillsOfExchange.Objects.Middlewares
{
    public class RRLogMiddleware
    {
        ...
        public RRLogMiddleware(RequestDelegate next, Action<RequestProfilerModel> requestResponseHandler)
        {
            _next = next;
